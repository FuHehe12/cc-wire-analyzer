...
**現在のバージョン：v0.3.2** · [リリース一覧](../../releases) · [変更履歴](CHANGELOG.md)

<!-- メンテナ：リリースのたびに上のバージョン行を更新すること（3 README 全部） -->

> 初めての方へ：**[docs/界面导览.md](docs/界面导览.md)** は UI で人が見るもの、
> **[docs/AI_USAGE.md](docs/AI_USAGE.md)** は本ツールを操作する AI エージェント向け、
> **[docs/架构总览.md](docs/架构总览.md)** は完全なアーキテクチャ、
> **[docs/文档维护策略.md](docs/文档维护策略.md)** はこれらの文書の同期を保つ方法。
