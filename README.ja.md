...
> 初めての方へ：**[docs/界面导览.md](docs/界面导览.md)**（中国語）は UI で人が見るもの、
> **[docs/AI_USAGE.md](docs/AI_USAGE.md)**（中国語）は本ツールを操作する AI エージェント向け、
> **[docs/架构总览.md](docs/架构总览.md)**（中国語）は完全なアーキテクチャ、
> **[docs/文档维护策略.md](docs/文档维护策略.md)**（中国語）はこれらの文書の同期を保つ方法。
