...
> **Before you write any code, read [`docs/reference/开发约定.md`](docs/product-manual.html#doc=开发约定.md) (Development Guide).**
...
> a change took effect: see [`docs/reference/开发约定.md`](docs/product-manual.html#doc=开发约定.md) §8.
...
1. **Run all seven self-tests.** The commands are listed in
   [`docs/reference/开发约定.md`](docs/product-manual.html#doc=开发约定.md) §8 — copy them from there rather than from memory,
...
4. Check your change against the safety invariants in [`docs/reference/开发约定.md`](docs/product-manual.html#doc=开发约定.md) §1.
...
| I want to… | Read |
|---|---|
| change code without breaking things | [`docs/reference/开发约定.md`](docs/product-manual.html#doc=开发约定.md) |
| understand how the app is put together | [`docs/reference/架构总览.md`](docs/reference/架构总览.md) |
| call the HTTP API | [`docs/reference/API契约.md`](docs/product-manual.html#doc=API契约.md) |
