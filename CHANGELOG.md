...
- **Current status**: **v0.4.25 (2026-09-04)** — retry storms merge into the turn they retry; thinking availability is judged by plaintext; doc_audit gates changelog entry size and docs blockquote style.
