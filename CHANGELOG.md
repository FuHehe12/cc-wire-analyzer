...
- **Current status**: **v0.4.23 (2026-09-02)** — one more auxiliary request is now recognised:
  the check Claude Code runs while you are away to decide whether to notify you.
